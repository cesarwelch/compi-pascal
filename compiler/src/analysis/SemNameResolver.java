...
public class SemNameResolver implements AbsVisitor {
	...
	public void visit(AbsConstDecl acceptor) {
		 // llamado a la funcion visit con la declaracion constante
		try {
	...
	public void visit(AbsExprStmt acceptor) {
		// Visit with expression statement
		acceptor.expr.accept(this);
	}

	@Override
	public void visit(AbsForStmt acceptor) {
		// Visit with for Statement
		AbsDecl decl = SemTable.fnd(acceptor.name.name);
		if(decl == null) {
